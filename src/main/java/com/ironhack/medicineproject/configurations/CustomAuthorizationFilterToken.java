...
public class CustomAuthorizationFilterToken extends OncePerRequestFilter {
    ...
    public CustomAuthorizationFilterToken(
            ...
            if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
                try {
                    ...
                    CustomUserDetails userDetails =
                            (CustomUserDetails) myUserDetailsService.loadUserByUsername(username);

                    // Create authentication using the CustomUserDetails object
